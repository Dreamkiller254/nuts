<x-layouts.site
    title="Cashew Processing & Export Supply | Nuts Paradise"
    description="Discuss cashew product requirements with Nuts Paradise for professional international supply and export preparation."
    body-class="content-page product-detail-page"
>
    <x-site.page-hero
        eyebrow="Cashews"
        heading="Cashews Prepared for Professional Supply"
        summary="Cashew products prepared around agreed requirements for international food, ingredient, distribution and retail buyers."
        cta-label="Request a Cashew Quote"
        image="assets/photos/cashew-bowl.jpg"
        image-alt="Cashew kernels displayed in a bowl"
    />

    <section class="np-section np-container content-split reveal">
        <div>
            <span class="np-label">Buyer-led preparation</span>
    ...
    <section class="product-detail-band alt">
        <div class="np-container product-detail-grid reverse">
            <div class="product-detail-copy reveal">
                <span class="np-label">Start with your use case</span>
    ...
    <x-site.cta heading="Discuss your cashew requirement." label="Request a Cashew Quote" />
</x-layouts.site>
